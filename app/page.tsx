    ...
    <main className="min-h-screen" style={{ background: 'var(--m-bg)' }}>
      ...
      <section className="px-6 py-20 max-w-2xl mx-auto">
        ...
        >
          ...
          <strong style={{ color: 'var(--m-text-primary)', fontWeight: 500 }}>
            Miroki
          </strong>{' '}
          helps you finish something.
        </p>
        ...
        {isLoggedIn ? (
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            <button
              ...
              className="flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl text-sm font-medium transition-opacity hover:opacity-80"
              ...
              <div key={i} className="flex gap-6">
                ...
                >
                  ...
                  {i < howSteps.length - 1 && (
                    <div
                      ...
                      style={{
                        background: step.done ? 'var(--m-accent)' : 'var(--m-border)',
                        minHeight: 40,
                      }}
                    />
                  )}
                ...
                <div className="pb-10 flex-1 min-w-0">
                  <p
                    ...
                    style={{
                      color: step.done ? 'var(--m-text-primary)' : 'var(--m-text-muted)',
                    }}
                  >
                    {step.title}
                  </p>
        ...
        <div className="px-6 py-20 max-w-2xl mx-auto">
          ...
          >
            <p
              ...
              style={{ color: 'var(--m-text-primary)' }}
            >
              <strong style={{ fontWeight: 500 }}>Miroki</strong> is early.
              <br />
              Follow the build.
            </p>
            ...
            <p
              ...
              style={{ color: 'var(--m-text-muted)' }}
            >
              Get updates on new features, improvements and the story behind building{' '}
              <strong style={{ color: 'var(--m-text-primary)', fontWeight: 500 }}>
                Miroki
              </strong>{' '}
              in public.
